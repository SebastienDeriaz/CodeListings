...
\lstdefinestyle{ST}{
	...
	keywords=[2]{AT, IF, THEN, ELSIF, END_IF, ELSE, UINT, BOOl, INT, DREAL, REAL, DINT, TIME, SINT, LINT, USINT, UDINT, ULINT, TIME_OF_DAY, DATE_AND_TIME, DATE, STRING, LREAL, CASE, ADR, POINTER, TO},
	keywords=[3]{:=,>,<,=,<=,>=,;,OR,AND},
