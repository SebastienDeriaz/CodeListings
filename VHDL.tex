...
\lstdefinestyle{VHDL}{
	keywords=[1]{library,use,all,entity,is,port,in,out,end,architecture,of,begin,and,signal, type, unsigned, signed, generic, port, use, ALL, downto, range, to, when, else, with, select, process, case, others, if, then, rising_edge, record, package, constant, procedure, function, report, severity},
